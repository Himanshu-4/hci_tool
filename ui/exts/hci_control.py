...
#         self.sub_window.setMinimumSize(200, 600)
#         self.sub_window.setWidget(self)
#         self.sub_window.setAttribute(Qt.WA_DeleteOnClose)  # Enable deletion on close
...
#         self.sub_window.resize(200, 600)

#         self.sub_window.setMinimumSize(200, 600)  # Set minimum size
#         self.sub_window.setAttribute(Qt.WA_DeleteOnClose)  # Enable deletion on close
#         self.sub_window.setWindowIconText("Connect Window")
...
#          # create a new subwindow for device connection
#         # create a new subwindow for device connection, make it modal like a pop-up dialog
#         self.sub_window = QMdiSubWindow()
#         self.sub_window.setWidget(self)                                   # put this widget inside the subwindow
#         self.sub_window.setWindowTitle("Log Window")
#         self.sub_window.setWindowIconText("Log Window")
#         # use Dialog flags so it behaves like a pop-up
#         self.sub_window.setWindowFlags(Qt.Dialog
#                            | Qt.WindowTitleHint
#                            | Qt.WindowCloseButtonHint)
#         # application-modal: must be closed before you can interact with other windows
#         self.sub_window.setWindowModality(Qt.ApplicationModal)
#         # sizing
#         self.sub_window.resize(800, 400)
#         self.sub_window.setMinimumSize(400, 200)
#         self.sub_window.setAttribute(Qt.WA_DeleteOnClose, True)          # auto-delete on close
...
#         self.transport_type.setCurrentText(transport_type[0].name)
