...
class LeMetaEventSubCode(IntEnum):
    ...
    # --- Core 5.4 / 6.0 additions, including Channel Sounding (0x29..0x30)
    PERIODIC_ADVERTISING_SUBEVENT_DATA_REQUEST = 0x24
    PERIODIC_ADVERTISING_RESPONSE_REPORT = 0x25
    ENHANCED_CONNECTION_COMPLETE_V2 = 0x26
    CIS_ESTABLISHED_V2 = 0x27
    READ_ALL_REMOTE_FEATURES_COMPLETE = 0x28
    CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE = 0x29
    CS_READ_REMOTE_FAE_TABLE_COMPLETE = 0x2A
    CS_SECURITY_ENABLE_COMPLETE = 0x2B
    CS_CONFIG_COMPLETE = 0x2C
    CS_PROCEDURE_ENABLE_COMPLETE = 0x2D
    CS_SUBEVENT_RESULT = 0x2E
    CS_SUBEVENT_RESULT_CONTINUE = 0x2F
    CS_TEST_END_COMPLETE = 0x30
    MONITORED_ADVERTISERS_REPORT = 0x31
    FRAME_SPACE_UPDATE_COMPLETE = 0x32
