...
class ControllerBasebandOCF(OCF):
    ...
    # Core Vol 4 Part E 7.3.47-7.3.54. These were each one low, so
    # Write_Page_Scan_Type would have gone out as Read_Page_Scan_Type and
    # Write_Inquiry_Scan_Type as Read_Inquiry_Mode.
